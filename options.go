...
// be written to info_log if it is set, or to a file stored
...
//	C.rocksdb_options_set_max_bytes_for_level_multiplier_additional(self.c, C.int(value))
//}
...
//	C.rocksdb_options_set_inplace_update_support(self.c, C.int(Btoi(value)))
//}

// Number of locks used for inplace update.
// Default: 10000, if inplace_update_support = true, else 0.
// TODO: implement in C
//func (self *Options) SetInplaceUpdateNumLocks(value bool) {
